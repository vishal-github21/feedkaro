...
export default function Home() {
  ...
  return (
    <div className="relative w-full h-screen bg-[url('./assets/bg.svg')]">
      ...
      <div className="absolute w-full "><Link href='/placelist'><button className="mt-4 mr-4 md:mr-8 lg:mr-16 float-right relative z-40 h-[5.5vh] w-[15vh] text-sm font-semibold hover:border-2 hover:bg-green-700 rounded-lg bg-green-500">Log In</button></Link></div>
