...
const Placelist = () => {
  ...
  return (
    <div className="flex flex-row">
      ...
      <div className="flex flex-col items-center w-[100%]">
      <button onClick={()=>setside(false)}><HiArrowLongLeft  className=" absolute right-5 top-5 h-7 w-7 mr-2 md:hidden"/></button>
      ...
      {!side && <div className="bg-gradient-to-br from-[#c9d5df] to-[#e7c8d4] flex flex-col p-8 h-screen md:w-[79%] md:hidden w-[100%]">
        ...
        <span className=" md:pl-6 z-20 text-2xl font-bold text-[#4368ffcb] font-sans">feedkaro</span>
          ...
          >
            <div className="md:h-[6vh] h-[5vh] w-[15vh] bg-[#C6CF10] hover:bg-[#BAC20C] hover:border-2 rounded-md flex justify-center items-center float-right md:mr-8 ">
              Your Places
            </div>
          </Link>
        </div>
